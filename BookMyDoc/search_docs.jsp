...
<input type="radio" name="type" value="ENT"> ENT<br>
<input type="radio" name="type" value="Dentist" checked> Dentist<br>
<input type="radio" name="type" value="Pathology"> Pathology<br>
<input type="radio" name="type" value="Dermatologist"> Dermatologist<br>
<input type="radio" name="type" value="Physician"> Physician<br></br>
<input type="submit" value="Submit">
<input type="hidden" name="page" value="search_docs.jsp">
</form>
<br>
<p></div>
</div>
