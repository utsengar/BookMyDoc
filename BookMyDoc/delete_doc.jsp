...
Enter The Doc ID To Delete
<form action="ControlServlet" method="post" name="del_doc">
<input name="deleteid" type="text" />
<input type="hidden" name="page" value="delete_doc.jsp">
<input name="Delete" type="submit" value="Delete Doctor" />
</form>
