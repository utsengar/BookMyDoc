...
<h2>Patients Interface - Avaliability</h2>
<form name="myform" action="ControlServlet" method="post">
<input type="checkbox" name="ENT" value="ENT"> ENT<br>
<input type="checkbox" name="Dentist" value="Dentist" checked> Dentist<br>
<input type="checkbox" name="Pathology" value="Pathology"> Pathology<br>
<input type="checkbox" name="Dermatologist" value="Dermatologist"> Dermatologist<br>
<input type="checkbox" name="Physician" value="Physician"> Physician<br></br>
...
<li><a href="change_pat_pass.jsp">Change Password</a></li>
