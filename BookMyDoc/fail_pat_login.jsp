...
<h2>Patients Interface</h2>


<p>Error In Login - Please Login Again
<p><form name="login_form" method="post" action="ControlServlet">
  ...
  <input type="text" name="id"/>
    ...
    <input type="hidden" name="page" value="fail_pat_login.jsp">
  </label><br /><br />
